...
var useFetch = function (url, resolver, options) {
    var _a = react_1.useReducer(reducer, { data: null, error: null, loading: false }), state = _a[0], dispatch = _a[1];
        ...
        var fetchData = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        res = _a.sent();
                        return [4 /*yield*/, res[resolver || 'json']()];
                    case 3:
